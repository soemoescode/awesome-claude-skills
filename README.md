...
- - [guardskill](https://github.com/soemoescode/guardskill) - Scan a repository for the git settings and hook scripts that let it execute code when a coding agent opens it.
