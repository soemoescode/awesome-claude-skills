...
- [guardskill](https://github.com/soemoescode/guardskill) - Scan a repository for the git settings, hook scripts and committed MCP server definitions that let it execute code when a coding agent opens it.
